      ...
      <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden my-8">
        ...
        <div className="p-4 border-b border-slate-200 flex items-center justify-between bg-slate-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900">Xem & In Tem Nhãn Barcode GS1-128</h2>
              <p className="text-xs text-slate-500 mt-0.5">Quy chuẩn nhãn dán Pallet / Thùng hàng dán ngoài kho</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 flex flex-col items-center justify-center bg-slate-100">
          <div className="w-full max-w-sm bg-white text-slate-950 p-5 rounded-xl shadow-lg border-2 border-slate-300 font-sans">
            {/* Tag Header */}
            <div className="flex items-center justify-between border-b-2 border-black pb-2 mb-3">
              ...
              <div className="text-right">
                <span className="inline-block px-2 py-0.5 text-xs font-black uppercase bg-black text-white rounded">
                  {product.storageZone}
                </span>
              </div>
            </div>
            ...
            <div className="border-t border-dashed border-slate-300 pt-3 flex flex-col items-center">
              ...
              <div className="font-mono text-sm font-black tracking-[0.25em] text-slate-900 mt-1.5">
                {product.barcode}
              </div>
              <div className="text-xs text-slate-500 font-mono mt-0.5 uppercase">
        ...
        <div className="p-4 border-t border-slate-200 flex items-center justify-between bg-slate-50">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onClose}
              className="px-4 py-2 rounded-xl bg-slate-200 hover:bg-slate-300 text-slate-800 text-sm font-semibold transition-colors"
            >
              Đóng
            </button>
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold shadow-md shadow-indigo-600/20 transition-all active:scale-95"
            >
